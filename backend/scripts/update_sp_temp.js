...
async function updateSP() {
    try {
        ...
        console.log("Connected. Executing SP update...");
        ...
        console.log("SUCCESS: Stored Procedure usp_GetMedicoCentros updated successfully.");
        process.exit(0);
    } catch (err) {
        console.error("ERROR: Failed to update SP.", err);
        process.exit(1);
    }
}
