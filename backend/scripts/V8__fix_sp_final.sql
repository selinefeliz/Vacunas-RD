-- V8: Final correction for usp_ScheduleAppointment, using the correct table name CitaVacunacion
...
BEGIN
    ...
    BEGIN TRY
        -- Corrected table name to CitaVacunacion
        INSERT INTO CitaVacunacion (id_Nino, id_Vacuna, id_CentroVacunacion, Fecha, Hora, id_UsuarioRegistraCita, id_EstadoCita, RequiereTutor)
