...
async function runMigration() {
    let pool;
    try {
        console.log('Connecting to the database to run usp_GetAllVaccinationCenters...');
        pool = await sql.connect(dbConfig);
        console.log('Connected.');

        const migrationFilePath = path.resolve(__dirname, '../../database/programmability/usp_GetAllVaccinationCenters.sql');
        ...
        console.log('Migration for usp_GetAllVaccinationCenters completed successfully!');
