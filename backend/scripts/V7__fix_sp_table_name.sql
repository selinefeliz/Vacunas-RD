-- V7: Corrects the table name in usp_ScheduleAppointment from Citas to Cita
...
BEGIN
    ...
    BEGIN TRY
        -- Corrected table name from Citas to Cita
        INSERT INTO Cita (id_Nino, id_Vacuna, id_CentroVacunacion, Fecha, Hora, id_UsuarioRegistraCita, id_EstadoCita, RequiereTutor)
